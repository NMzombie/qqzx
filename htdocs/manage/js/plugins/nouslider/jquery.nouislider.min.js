...
(function (b) {
    ...
    g.prototype.p = function (a, e, d, g) {
        ...
        this.update = !g;
        if ("string" ===
            typeof a && 0 === a.indexOf("-tooltip-")) this.K(a, e); else if ("string" === typeof a && 0 !== a.indexOf("-")) this.H(a); else if ("function" === typeof a) this.target = !1, this.method = a; else {
    ...
    function T(d, c, h) {
        ...
        function t(a, b, d, f) {
            ...
            b.on(a, function (a) {
                ...
                a.preventDefault();
                var b = 0 === a.type.indexOf("touch"), p = 0 === a.type.indexOf("mouse"),
                    e = 0 === a.type.indexOf("pointer"), D, g, l = a;
